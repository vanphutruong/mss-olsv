...
(function(f) {
    ...
    p(Chart.prototype, {
        getSVG: function(b) {
            ...
            p(g.chart, {
                ...
                renderTo: b,
                // forExport: !0,
                forExport: g.exporting.allowHTML !== true,
                width: c,
                height: h
            });
    ...
    Chart.prototype.callbacks.push(function(b) {
