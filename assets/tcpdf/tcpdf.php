...
class MYPDF extends TCPDF {
    public function Footer($ID_COM = '') 
    {
        ...
        $this->SetFont('helvetica', 'N', 12);
        $this->setCellPaddings(0,1,0,0);
        $this->Cell(0, 5, "© 2014, Hay Group Pte Ltd. All Rights Reserved.", 0, false, 'L', 0, '', 0, false, 'T', 'M');
        $this->setCellPaddings(0,1,-10,0);
        $this->Cell(0, 5, $this->getAliasNumPage(), 0, false, 'R', 0, '', 0, false, 'T', 'M');
